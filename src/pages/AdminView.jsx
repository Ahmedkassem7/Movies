    ...
    <div className="d-flex flex-column w-100">
      ...
      <div className="d-flex flex-column flex-xl-row justify-content-between mt-3 mb-3 g-4">
        <div className="col-12 col-xl-6 mb-4 mb-xl-0">
          <SharedList category={"Movies"} getAllAction={getAllMoviesAction} selectorName="movieSlice"/>
        </div>
        <div className="col-12 col-xl-6">
          <SharedList category={"Series"} getAllAction={getAllSeriesAction} selectorName="seriesSlice"/>
        </div>
      </div>
    </div>
  );
